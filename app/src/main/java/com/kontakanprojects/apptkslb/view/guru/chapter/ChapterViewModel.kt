...
class ChapterViewModel : ViewModel() {
    ...
    fun editChapters(
        ...
        namaChapter: String,
        idMapel: Int
    ): LiveData<ResponseChapter?> {
        ubahChapter(idChapter, namaChapter, idMapel)
        return _chapter
    }

    fun deleteChapters(idMapel: Int, idChapter: Int): LiveData<ResponseChapter?> {
        hapusChapter(idMapel, idChapter)
        return _chapter
    }
    ...
    private fun hapusChapter(idMapel: Int, idChapter: Int) {
